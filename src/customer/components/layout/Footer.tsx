...
import igniteLogo from "src/customer/assets/images/ignite_white.svg";
import merklFooter from "src/customer/assets/images/merkl-footer.svg";
import footerMp4 from "src/customer/assets/video/footer.mp4";
