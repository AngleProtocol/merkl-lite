...
import { type Coloring, createColoring, Container } from "dappkit";
    ...
    <Container>
      <Heading
        ...
        tabs={[
          ...
          { label: "Leaderboard", link: "/opportunities/leaderboard" },
          { label: "Analytics", link: "/opportunities/analytics" },
        ]}>
        <Outlet />
      </Heading>
    </Container>
